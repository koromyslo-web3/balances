...
Revision ID: e06d0df53fa3
Revises: 
Create Date: 2025-05-02 17:20:47.812019
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_balances_address'), 'balances', ['address'], unique=True)
